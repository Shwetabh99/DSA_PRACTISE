  public class Main
{
    public static void conquer(int [] arr, int starti, int mid, int endi){
        ...
        while(idx1<=mid && idx2 <=endi){   // loop through the array
            if(idx1<=idx2){                // comparing elements of divided array
    ...
    public static void divide(int [] arr, int starti, int endi){    //to divide we have to pass start and end Index
        if(starti>=endi){
            return;     // base case
        }
